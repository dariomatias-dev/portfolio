...
export const PhilosophySection = () => {
  const quotes = [
    ...
    },
    {
      ...
      gradient: "from-indigo-50 via-purple-50/50 to-white",
    },
    {
      text: "The best way to predict the future is to invent it.",
      author: "Alan Kay",
      gradient: "from-violet-50 via-fuchsia-50/50 to-white",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quotes.map((quote, index) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-linear-to-br ${quote.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out`}
              />
